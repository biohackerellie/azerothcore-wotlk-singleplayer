...
-- Dumping data for table acore_characters.guild_rank: ~5 rows (approximately)
INSERT IGNORE INTO `guild_rank` (`guildid`, `rid`, `rname`, `rights`, `BankMoneyPerDay`) VALUES
	(1, 0, 'Guild Master', 1962495, 4294967295),
	(1, 1, 'Officer', 1962495, 1316124912),
	(1, 2, 'Veteran', 67, 0),
	(1, 3, 'Member', 67, 0),
	(1, 4, 'Initiate', 67, 0);
