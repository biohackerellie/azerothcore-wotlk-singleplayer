...
-- Dumping data for table acore_characters.character_entry_point: ~2 rows (approximately)
INSERT IGNORE INTO `character_entry_point` (`guid`, `joinX`, `joinY`, `joinZ`, `joinO`, `joinMapId`, `taxiPath0`, `taxiPath1`, `mountSpell`) VALUES
	(3, -14459.2, 427.861, 25.1729, 3.80945, 0, 0, 0, 0),
	(4, -8876.36, 643.891, 96.0592, 0.474012, 0, 0, 0, 0);
