...
-- Dumping data for table acore_characters.character_homebind: ~3 rows (approximately)
INSERT IGNORE INTO `character_homebind` (`guid`, `mapId`, `zoneId`, `posX`, `posY`, `posZ`, `posO`) VALUES
	(2, 0, 1637, -8866.55, 671.39, 97.9, 0),
	(3, 0, 1519, -8865.55, 671.248, 97.9033, 2.01637),
	(4, 0, 1537, -4839.85, -858.987, 502.782, 1.36064);
