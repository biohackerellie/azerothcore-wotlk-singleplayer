...
-- Dumping data for table acore_characters.character_spell_cooldown: ~1 rows (approximately)
INSERT IGNORE INTO `character_spell_cooldown` (`guid`, `spell`, `category`, `item`, `time`, `needSend`) VALUES
	(4, 39937, 1176, 6948, 1675737405, 0);
