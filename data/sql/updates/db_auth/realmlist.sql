...
CREATE TABLE IF NOT EXISTS `realmlist` (
  ...
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '10.50.1.7',
  `localAddress` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '10.50.1.7',
...
INSERT IGNORE INTO `realmlist` (`id`, `name`, `address`, `localAddress`, `localSubnetMask`, `port`, `icon`, `flag`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`) VALUES
	(1, 'AzerothCore', '10.50.1.7', '10.50.1.7', '255.255.255.0', 8085, 8, 0, 1, 0, 0, 12340);
